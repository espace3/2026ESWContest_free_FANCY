...
[두 축을 어긋나지 않게 합치는 원칙 — 한 프레임 = 한 관측 = 한 명령]
  ...
  단, 팬은 유성기어라 빠르고 틸트는 92.6:1 웜기어라 ≈11°/s로 느려서, 대각선 이동 시
...
from tracking_core import add_state_args, open_motor_from_args, run_pantilt_tracking
